...
/**
 * Tests {@link NullableCodeableIntegerEncoding}.
 */
class NullableCodeableIntegerEncodingTest extends EncodingTestSupport {

  public enum Season implements Codeable<Integer> {
    SPRING(1),
    SUMMER(2),
    FALL(3),
    WINTER(4);
  ...
  public static class SeasonEncoding extends NullableCodeableIntegerEncoding<Season> {
  }

  public static class Message {
    @AvroEncode(using = SeasonEncoding.class)
