...
class CompatibilityDirectionTest {
  ...
  static Stream<Arguments> given_compatibility_direction_when_check_then_compatibility_type() {
    return Stream.of(
/* TODO: Add these tests after https://issues.apache.org/jira/browse/AVRO-3612 is fixed.
...
*/
  ...
  @MethodSource
  @ParameterizedTest
  void given_compatibility_direction_when_check_then_compatibility_type(
